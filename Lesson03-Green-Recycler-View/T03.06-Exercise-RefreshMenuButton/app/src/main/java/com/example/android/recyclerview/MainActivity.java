...
public class MainActivity extends AppCompatActivity {
    ...
    // CEOMPLETED (9) Return true to display this menu
    @Override
    ...
    // COMPLETED (12) If the ID equals R.id.action_reset, create and set a new adapter on the RecyclerView and return true
